...
rownames(dumMat) = paste(dumTab2$outcome,rep(c("X1","X2"),4),sep=" - ")
...
#' 
dumTab3 = cbind(dumTab_X1[,c(1,2,3,8,13),with=F],dumTab_X2[,c(2,3,8,13),with=F])
x = dim(dumTab3)[2]
dumMat3 = as.matrix(dumTab3[,2:x])

colnames(dumMat3) = paste(rep(c("X1","X2"),each=4),colnames(dumMat3),sep=" - ")
...
dumTab3 = copy(dumTab)
dumTab3[,bias_X1 := bias_X2]
dumTab3[,bias_SE_X1 := bias_SE_X2]
dumTab3[,type := "slope"]
...
dumTab3 = copy(dumTab)
dumTab3[,mean_betaIVW2_X1 := mean_betaIVW2_X2]
dumTab3[,sd_betaIVW2_X1 := sd_betaIVW2_X2]
dumTab3[,type := "slope"]
...
data_hlines = data.frame(type = c("mean","mean","slope"),
                         mylines = c(0.3,1.2,0.3))
...
dumTab3 = copy(dumTab)
dumTab3[,mean_betaIVW_X1 := mean_betaIVW_X2]
dumTab3[,sd_betaIVW_X1 := sd_betaIVW_X2]
dumTab3[,type := "slope"]
...
dumTab3 = copy(dumTab)
dumTab3[,condFStats_median_X1 := condFStats_median_X2]
dumTab3[,condFStats_1stQ_X1 := condFStats_1stQ_X2]
dumTab3[,condFStats_3rdQ_X1 := condFStats_3rdQ_X2]
dumTab3[,type := "slope"]
