...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/05_MVMRInput_SENS_SNPset2_1SMR.RData"))
...
save(MVMR_results,file = paste0("../results/05_MVMR_06_SENS_SNPset2_1SMR.RData"))
