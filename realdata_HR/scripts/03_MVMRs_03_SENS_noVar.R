#' ---
#' title: "MVMR - SENS analysis - no variability"
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/03_MVMRInput_SENS_03_noVar.RData"))
...
save(MVMR_results,file = paste0("../results/03_MVMR_03_SENS_noVar.RData"))
