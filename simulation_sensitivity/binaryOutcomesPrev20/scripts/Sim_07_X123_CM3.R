...
{
  outfiles_prefix = "Sim_07_X123_CM3"
...
SimTab = foreach(s = 1:n_sim)%dorng%{
  ...
  #' ***
  {
    ...
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y1),location = qlogis(0.85)))
    myTabY[,Y1_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y2),location = qlogis(0.85)))
    myTabY[,Y2_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y3),location = qlogis(0.85)))
    myTabY[,Y3_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y4),location = qlogis(0.85)))
    myTabY[,Y4_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y5),location = qlogis(0.85)))
    myTabY[,Y5_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y6),location = qlogis(0.85)))
    myTabY[,Y6_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y7),location = qlogis(0.85)))
    myTabY[,Y7_bin := y_dummy]
    y_dummy = rbinom(n = n_samples, size = 1, prob = plogis(scale(myTabY$Y8),location = qlogis(0.85)))
    myTabY[,Y8_bin := y_dummy]
    
    #' Check AS association
    # summary(glm(myTabY$Y1_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y2_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y3_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y4_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y5_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y6_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y7_bin ~ AS1 + AS2 + AS3,family = "binomial"))
    # summary(glm(myTabY$Y8_bin ~ AS1 + AS2 + AS3,family = "binomial"))
