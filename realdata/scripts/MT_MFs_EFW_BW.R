...
MVMR_results = MVMR_results[outcome == "pn_bw"]
...
print(xtable(MVMR12, type = "latex",digits = 3),file = "../results/_tables/RealData_mainTable2.tex")
...
filename = paste0("../results/_figures/MF_ForestPlots_EFW_BW_Mean.png")
...
filename = paste0("../results/_figures/MF_ForestPlots_EFW_BW_Slope.png")
png(filename = filename,width = 2000, height = 1600, res=200)
plot(p2)
dev.off()
...
filename = paste0("../results/_figures/MF_ForestPlots_EFW_BW_Variability.png")
png(filename = filename,width = 2000, height = 1600, res=200)
plot(p2)
dev.off()
