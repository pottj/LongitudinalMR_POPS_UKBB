...
R CMD BATCH --vanilla ../scripts/07_2SampleMR_01a_BW.R ../scripts/07_2SampleMR_01a_BW.R.out
cp Rplots.pdf 07_2SMR_01a_RPlots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/07_2SampleMR_01b_CS.R ../scripts/07_2SampleMR_01b_CS.R.out
cp Rplots.pdf 07_2SMR_01b_RPlots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/07_2SampleMR_02_ForestPlots_perExposure_main.R ../scripts/07_2SampleMR_02_ForestPlots_perExposure_main.R.out
cp Rplots.pdf 07_2SMR_02_RPlots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/07_2SampleMR_03_ForestPlots_perExposureType_main.R ../scripts/07_2SampleMR_03_ForestPlots_perExposureType_main.R.out
cp Rplots.pdf 07_2SMR_03_RPlots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/07_2SampleMR_04_ForestPlots_vs_1Sample.R ../scripts/07_2SampleMR_04_ForestPlots_vs_1Sample.R.out
cp Rplots.pdf 07_2SMR_04_RPlots.pdf
rm Rplots.pdf
