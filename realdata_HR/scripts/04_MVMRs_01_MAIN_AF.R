#' ---
#' title: "MVMR - main analysis (HR on AF)"
...
save(myAssocs_X_long,myAssocs_Y,LDTab, file = paste0("../temp/04_MVMRInput_MAIN.RData"))
...
save(MVMR_results1,file = paste0("../results/04_MVMR_01_MAIN_AF_msv.RData"))
...
save(MVMR_results2,file = paste0("../results/04_MVMR_01_MAIN_AF_mv.RData"))
