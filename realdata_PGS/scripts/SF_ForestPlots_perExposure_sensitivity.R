...
load("../results/04_MVMR_02_SENS_GBR3_240414.RData")
MVMR_results = MVMR_results[setting == "multivariate"]
matched = match(MVMR_results$exposure,matchingTable$old)
MVMR_results[,exposure := matchingTable[matched,new]]
matched = match(MVMR_results$outcome,matchingTable$old)
...
load("../results/04_MVMR_03_SENS_LMM_240414.RData")
MVMR_results = MVMR_results[setting == "multivariate"]
matched = match(MVMR_results$exposure,matchingTable$old)
MVMR_results[,exposure := matchingTable[matched,new]]
matched = match(MVMR_results$outcome,matchingTable$old)
MVMR_results[,outcome := matchingTable[matched,new]]
MVMR_LMM = copy(MVMR_results)
MVMR_LMM[,ID := gsub("sens_","sens2_",ID)]

load("../results/04_MVMR_04_SENS_SigmaTimeIndep_240414.RData")
MVMR_results = MVMR_results[setting == "multivariate"]
matched = match(MVMR_results$exposure,matchingTable$old)
MVMR_results[,exposure := matchingTable[matched,new]]
matched = match(MVMR_results$outcome,matchingTable$old)
...
load("../results/04_MVMR_05_SENS_noTimeIA_240414.RData")
MVMR_results = MVMR_results[setting == "multivariate"]
matched = match(MVMR_results$exposure,matchingTable$old)
MVMR_results[,exposure := matchingTable[matched,new]]
matched = match(MVMR_results$outcome,matchingTable$old)
MVMR_results[,outcome := matchingTable[matched,new]]
MVMR_noTimeIA = copy(MVMR_results)
MVMR_noTimeIA[,ID := gsub("sens_","sens3_",ID)]

load("../results/04_MVMR_07_SENS_noCovars_240414.RData")
MVMR_results = MVMR_results[setting == "multivariate"]
matched = match(MVMR_results$exposure,matchingTable$old)
MVMR_results[,exposure := matchingTable[matched,new]]
matched = match(MVMR_results$outcome,matchingTable$old)
...
MVMR = rbind(MVMR_main,MVMR_GBR3,MVMR_LMM,MVMR_SigmaTimeIndep,MVMR_noTimeIA,MVMR_noCovars)
MVMR[,table(ID)]
...
dumTab0 = foreach(k = 1:length(myOutcomes))%do%{
  ...
  dumTab1 = foreach(i = 1:length(myExposures))%do%{
    ...
    dumTab2 = foreach(j = 1:length(myExposure_Types))%do%{
      ...
      filename = paste0("../results/_figures/SF_ForestPlots_",myX,"_",myY,"_",myExposure_Type,".png")
