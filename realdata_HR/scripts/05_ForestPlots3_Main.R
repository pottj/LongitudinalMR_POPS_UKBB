...
myXlab = 
  "Causal effect of HR (constant) on CAD by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRconstant_CAD.png")
...
MVMR_results = MVMR_results[grepl("combined",exposure),]
MVMR_results = MVMR_results[grepl("combined",outcome),]
MVMR_results[outcome == "UKB_AF_combined",ID:="1SMR - AF (UKBB)"]
...
myXlab = 
  "Causal effect of HR (constant) on AF by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRconstant_AF.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
...
myXlab = 
  "Causal effect of HR (ramp-up) on CAD by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRrampup_CAD.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
...
myXlab = 
  "Causal effect of HR (ramp-up) on AF by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRrampup_AF.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
