...
#' # Load data ####
#' ***
load("../results/_tables/Simulation_complete_main_v2.RData")
...
# get tables
myTab_X13_2 = copy(myTab)
myTab_X13_2 = myTab_X13_2[Sim_X == "X13",]
myTab_X13_2[,Sim_X := NULL]

#' # Save ####
#' ***
excel_fn = paste0("../results/MainTab_X13correction.xlsx")
WriteXLS(c("myTab_X13_2"),
         ExcelFileName=excel_fn,
         SheetNames=c("Sim_X13_corrected"),
         AutoFilter=T,
         BoldHeaderRow=T,
         FreezeRow=1)
