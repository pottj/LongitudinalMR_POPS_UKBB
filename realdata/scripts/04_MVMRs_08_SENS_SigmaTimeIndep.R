...
#' # Introduction ####
#' ***
#' Sensitivity: using no time adjustment in the sigma model 
#' 
#' # Initialize ####
#' ***
rm(list = ls())
...
#' ## Exposure
load("../results/02_SNPs_01_SENS_Assocs_exposure_gamlssIA_all2_gaQuad_SigmaTimeIndep_240322.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_SigmaTimeIndep_",tag,".RData"))
