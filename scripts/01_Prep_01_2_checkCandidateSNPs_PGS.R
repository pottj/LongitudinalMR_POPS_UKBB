...
#' ***
PGS_data = fread("../data/PGS001226_hmPOS_GRCh38.txt.gz")
head(PGS_data)
...
outFile1 = paste0("../results/01_Prep_01_2_SNPList_PGS_",tag,".RData")
save(matchedData, file = outFile1)

outFile2 = paste0("../results/01_Prep_01_2_SNPList_PGS_IDonly_",tag,".txt")
write.table(matchedData$SNP, file = outFile2,col.names = F,row.names = F, quote = F)

outFile3 = paste0(POPS_SNP_data,"01_Prep_01_2_SNPList_PGS_IDonly_",tag,".txt")
write.table(matchedData$SNP, file = outFile3,col.names = F,row.names = F, quote = F)

outFile4 = paste0(POPS_SNP_data,"01_Prep_01_2_SNPList_PGS_EA_",tag,".txt")
