...
#' ## Exposure
load("../results/02_SNPs_06_SENS_noCovars.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_noCovars.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_06_SENS_noCovars.RData"))
