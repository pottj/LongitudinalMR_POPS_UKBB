...
R CMD BATCH --vanilla ../scripts/05_GXchecks_01_Trajectories.R ../scripts/05_GXchecks_01_Trajectories.R.out
cp Rplots.pdf 05_GXchecks_01_RPlots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/05_GXchecks_02_GenCor.R ../scripts/05_GXchecks_02_GenCor.R.out

R CMD BATCH --vanilla ../scripts/05_GXchecks_03_GenCor_slides.R ../scripts/05_GXchecks_03_GenCor_slides.R.out
