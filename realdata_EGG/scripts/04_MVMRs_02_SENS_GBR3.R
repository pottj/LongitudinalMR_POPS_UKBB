...
#' ## Exposure
load("../results/02_SNPs_02_SENS_GBR3.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_GBR3.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_02_SENS_GBR3.RData"))
