...
MVMR_results = MVMR_results[outcome %in% c("UKB_CAD_males","Agaram_CAD_combined"),]
MVMR_results[outcome == "UKB_CAD_males",ID:="1SMR - CAD (UKBB)"]
...
myXlab = 
  "Causal effect of HR (constant, men) on CAD by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRconstant_CAD_men.png")
...
MVMR_results = MVMR_results[setting == "multivariate"]
MVMR_results = MVMR_results[grepl("_men",exposure),]
MVMR_results = MVMR_results[outcome %in% c("UKB_AF_males","Miyazawa_AF_combined"),]
MVMR_results[outcome == "UKB_AF_males",ID:="1SMR - AF (UKBB)"]
...
myXlab = 
  "Causal effect of HR (constant, men) on AF by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRconstant_AF_men.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
...
myXlab = 
  "Causal effect of HR (ramp-up, men) on CAD by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRrampup_CAD_men.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
...
myXlab = 
  "Causal effect of HR (ramp-up, men) on AF by exposure type"
...
filename = paste0("../results/_figures/05_ForestPlots3_Main/HRrampup_AF_men.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
