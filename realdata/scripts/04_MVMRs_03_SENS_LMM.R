...
#' # Introduction ####
#' ***
#' Sensitivity: estimating only mean and slope, no var effect (LMM)
#' 
#' # Initialize ####
#' ***
rm(list = ls())
...
#' ## Exposure
load("../results/02_SNPs_03_SENS_LMM_240414.RData")
...
save(MVMR_results,file = paste0("../results/04_MVMR_03_SENS_LMM_",tag,".RData"))
