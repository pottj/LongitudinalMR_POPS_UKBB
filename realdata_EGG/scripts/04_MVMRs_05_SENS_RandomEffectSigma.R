#' ---
#' title: "Get MVMR within POPS - SENS analysis - random effect in sigma function"
...
#' ## Exposure
load("../results/02_SNPs_05_SENS_RandomEffectSigma.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_RandomEffectSigma.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_05_SENS_RandomEffectSigma.RData"))
