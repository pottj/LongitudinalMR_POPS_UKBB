...
#SBATCH -J LongMR_03_SNPs_outcome
...
R CMD BATCH --vanilla ../scripts/03_SNPs_01_MAIN_Outcome.R ../scripts/03_SNPs_01_MAIN_Outcome.R.out

R CMD BATCH --vanilla ../scripts/03_SNPs_02_SENS_Outcome.R ../scripts/03_SNPs_02_SENS_Outcome.R.out
