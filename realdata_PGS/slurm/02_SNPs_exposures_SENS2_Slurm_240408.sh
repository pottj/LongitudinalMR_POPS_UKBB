...
#SBATCH -J LongMR_02_SNPs_exposures_SENS_2
...
R CMD BATCH --vanilla ../scripts/02_SNPs_01_SENS_gamlssIA_all2_gaQuad_noTimeIA.R ../scripts/02_SNPs_01_SENS_gamlssIA_all2_gaQuad_noTimeIA.R.out
