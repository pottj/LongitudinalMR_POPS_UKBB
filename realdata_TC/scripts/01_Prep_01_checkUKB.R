...
filename = paste0("../results/_figures/01_Trajectory_TC.png")
...
#' # Save data ####
#' ***
save(myTab6, myTab7, file = paste0(UKB_phenotypes_filtered,"/01_Prep_01_UKB_GP_TC.RData"))
write.table(myTab7$ID,file = paste0(UKB_phenotypes_filtered,"/01_Prep_01_SampleList_TC.txt"), 
