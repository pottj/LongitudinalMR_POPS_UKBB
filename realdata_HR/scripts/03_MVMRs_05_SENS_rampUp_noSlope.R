#' ---
#' title: "MVMR - SENS analysis - ramp-up - no slope"
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/03_MVMRInput_SENS_05_rampUp_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/03_MVMR_05_SENS_rampUp_noSlope.RData"))
