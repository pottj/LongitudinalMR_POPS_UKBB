#' ---
#' title: "MVMR - SENS analysis - no variability - AF"
...
#' ## Exposure
load("../results/02_SNPs_03_SENS_noVar.RData")
...
save(myAssocs_X_long,myAssocs_Y,LDTab, file = paste0("../temp/04_MVMRInput_SENS_03_noVar.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_03_SENS_noVar_AF.RData"))
