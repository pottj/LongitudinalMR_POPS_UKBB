MVMR_jp_POPS_top20 = function(data_exposure,exposure_name, data_outcome, outcome_name,getPlot,flag,SNPSets,corTab,corTab_threshold,sampleSize_GX=15000,random=F,getCondF=F,getUni=T){
  #debug
