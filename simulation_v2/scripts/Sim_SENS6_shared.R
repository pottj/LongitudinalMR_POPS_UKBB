...
#' - SNP sets: shared
#' 
#' **Regression model**: LinMixed
#' 
#' - Time: age
#' - Growth: quadratic
#' - SNP x Time - interaction: TRUE
#' - Sigma dependencies: NA
#' 
#'
#' # Initialize ####
#' ***
...
{
  outfiles_prefix = "Sim_SENS6_shared"
  ...
  AssocModelX = "linMixed"  # either linMixed or gamlssIA or gamlss
