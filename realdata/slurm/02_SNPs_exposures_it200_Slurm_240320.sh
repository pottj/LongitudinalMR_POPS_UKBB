...
#SBATCH -J LongMR_02_SNPs_exposures_200it
...
R CMD BATCH --vanilla ../scripts/02_SNPs_01_SENS_gamlssIA_all2_gaQuad_it200.R ../scripts/02_SNPs_01_SENS_gamlssIA_all2_gaQuad_it200.R.out
