#' ---
#' title: "MVMR - SENS analysis - no slope"
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/03_MVMRInput_SENS_04_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/03_MVMR_04_SENS_noSlope.RData"))
