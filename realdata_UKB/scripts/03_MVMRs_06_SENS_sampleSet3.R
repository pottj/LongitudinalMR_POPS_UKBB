...
#' ## Exposure
load("../results/02_SNPs_06_SENS_sampleSet3.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/03_MVMRInput_SENS_sampleSet3"))

#' # Do MVMR ####
#' ***
#' 
mySampleSize = c(36830)
myOutcomes = unique(myAssocs_Y_long$type)
myFlag = "sens_sampleSet3"
...
save(MVMR_results,file = paste0("../results/03_MVMR_06_SENS_sampleSet3.RData"))
