...
R CMD BATCH --vanilla ../scripts/02_SNPs_01_MAIN.R ../scripts/02_SNPs_01_MAIN.R.out

R CMD BATCH --vanilla ../scripts/02_SNPs_03_SENS_noVar.R ../scripts/02_SNPs_03_SENS_noVar.R.out

R CMD BATCH --vanilla ../scripts/02_SNPs_04_SENS_noSlope.R ../scripts/02_SNPs_04_SENS_noSlope.R.out
