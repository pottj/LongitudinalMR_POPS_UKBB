#' ---
#' title: "Get association of SNPs on TC (SENS: no slope)"
...
#' # Introduction ####
#' ***
#' Here, I want to estimate the SNP effects in a **gamlssIA** model for TC. I will estimate only estimate the SNP effects on the mean and variability, **not on the slope**.
#' 
#' # Initialize ####
#' ***
rm(list = ls())
