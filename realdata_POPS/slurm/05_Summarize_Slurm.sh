...
# Script for Supplemental Figures (GenCor & Venn diagram)
R CMD BATCH --vanilla ../scripts/05_Summarize_06_SupFigs_GenCor.R ../scripts/05_Summarize_06_SupFigs_GenCor.R.out
cp Rplots.pdf 05_06_SupFig_Rplots.pdf
rm Rplots.pdf
