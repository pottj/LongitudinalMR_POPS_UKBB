#' ---
#' title: "MVMR - SENS analysis (ramp-up)"
...
#' ## Exposure
load("../results/02_SNPs_02_SENS_RampUp.RData")
...
save(myAssocs_X_long,myAssocs_Y,LDTab, file = paste0("../temp/04_MVMRInput_SENS_rampUp.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_02_SENS_rampUp.RData"))
