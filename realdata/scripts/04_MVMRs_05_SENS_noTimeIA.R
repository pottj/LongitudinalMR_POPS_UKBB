...
#' ## Exposure
load("../results/02_SNPs_05_SENS_noTimeIA_240413.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_noTimeIA_",tag,".RData"))

#' # Do MVMR ####
#' ***
myExposures = unique(myAssocs_X_long$phenotype)
myOutcomes = unique(myAssocs_Y$phenotype)
myFlag = "sens_noTimeIA"
set.seed(2024)
...
save(MVMR_results,file = paste0("../results/04_MVMR_05_SENS_noTimeIA_",tag,".RData"))
