...
R CMD BATCH --vanilla ../scripts/04_Summarize_01_MainFig_ForestPlot.R ../scripts/04_Summarize_01_MainFig_ForestPlot.R.out
cp Rplots.pdf 04_01_MainFig_Rplots.pdf
rm Rplots.pdf

# Script for Supplemental Tables
R CMD BATCH --vanilla ../scripts/04_Summarize_02_SupTables.R ../scripts/04_Summarize_02_SupTables.R.out

# Script for Supplemental Figures (Forest Plots)
R CMD BATCH --vanilla ../scripts/04_Summarize_03_SupFigs_ForestPlots.R ../scripts/04_Summarize_03_SupFigs_ForestPlots.R.out
cp Rplots.pdf 04_03_SupFig_Rplots.pdf
rm Rplots.pdf

# Script for Supplemental Figures (Scatter Plots)
R CMD BATCH --vanilla ../scripts/04_Summarize_04_SupFigs_ScatterPlots.R ../scripts/04_Summarize_04_SupFigs_ScatterPlots.R.out
...
# Script for Supplemental Figures (Histograms)
R CMD BATCH --vanilla ../scripts/04_Summarize_08_SupFigs_Histograms.R ../scripts/04_Summarize_08_SupFigs_Histograms.R.out
cp Rplots.pdf 04_08_SupFig_Rplots.pdf
rm Rplots.pdf
