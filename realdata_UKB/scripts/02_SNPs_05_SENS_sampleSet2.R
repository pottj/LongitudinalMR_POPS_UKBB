...
#' # Introduction ####
#' ***
#' Here, I want to estimate the SNP effects in a **gamlssIA** model for TC. I will estimate estimate all the SNP effects **in a different sample set** (UKB baseline and after baseline).
#' 
#' # Initialize ####
#' ***
rm(list = ls())
...
save(myAssocs_X,file=paste0("../results/02_SNPs_05_SENS_sampleSet2.RData"))
