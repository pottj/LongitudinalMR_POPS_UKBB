...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/05_MVMRInput_SENS_noSlope_1SMR.RData"))
...
save(MVMR_results,file = paste0("../results/05_MVMR_03_SENS_noSlope_1SMR.RData"))
