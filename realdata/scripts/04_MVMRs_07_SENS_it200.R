...
#' # Introduction ####
#' ***
#' Sensitivity: using 200 iterations in the gamlss model instead of 20
#' 
#' # Initialize ####
#' ***
rm(list = ls())
...
#' ## Exposure
load("../results/02_SNPs_01_SENS_Assocs_exposure_gamlssIA_all2_gaQuad_it200_240322.RData")
...
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/04_MVMRInput_SENS_it200_",tag,".RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_07_SENS_it200_",tag,".RData"))
