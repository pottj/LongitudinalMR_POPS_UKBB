#' ---
#' title: "MVMR - sens - different SNP selection"
...
#' ## Exposure
load("../results/02_SNPs_05_SENS_SNPset.RData")
...
#' ## Outcome
load("../results/02_SNPs_07_MAIN_outcome.RData")

#' ## save as temporary files
goodSNPs = myAssocs_Y[,.N,by = SNP]
goodSNPs = goodSNPs[N==3,]
myAssocs_X_long = myAssocs_X_long[SNP %in% goodSNPs$SNP,]
myAssocs_Y = myAssocs_Y[SNP %in% goodSNPs$SNP,]
save(myAssocs_X_long,myAssocs_Y, file = paste0("../temp/05_MVMRInput_SENS_SNPSet_1SMR.RData"))
...
myAssocs_Y[,phenotype := paste0("CAD_",model)]
...
save(MVMR_results,file = paste0("../results/05_MVMR_05_SENS_SNPSet_1SMR.RData"))
