#' ---
#' title: "MVMR - SENS analysis - no slope - AF"
...
save(myAssocs_X_long,myAssocs_Y,LDTab, file = paste0("../temp/04_MVMRInput_SENS_04_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_04_SENS_noSlope_AF.RData"))
